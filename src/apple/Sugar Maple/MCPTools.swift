...
enum MCPTools {
    static let names = ["capabilities","document.get","document.new","transaction.apply","history.undo","history.redo","selection.set","code.export","layout.inspect","viewport.fit","render.capture"]
